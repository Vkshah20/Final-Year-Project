# This  model will take 100 input and output 101 to 110 close price
from keras.models import load_model
import pandas as pd
import numpy as np
def lstm(start,end):
    model = load_model('./model/lstm_k_100_o_110_feature_1.h5')
    ...
    tmp = pred[0]
    tmp = (tmp * ts[1]) + tm[1]
    dataframe = pd.DataFrame(tmp, columns=['Close'])
