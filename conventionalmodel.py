...
def convenmodel(start,end):
    model = load_model('./model/conv_model_k_100.h5')
    ...
    print("\n\nAs this conventional Model has one output might be possible that you undable to see on screen so output is displayed in terminal.")
    print(dataframe1)
